...
pub fn app() -> Element {
    ...
    let mut is_pro = use_signal(|| false);
        ...
        div { class: "root",
            ...
            if has_messages {
                div { class: "panel-tabs",
                    ...
                    button {
                        ...
                        if pro { "Trade Lifecycle" } else { "✦ Trade Lifecycle" }
                    }
                }
            }
            ...
            if *show_license_modal.read() {
                div {
                    ...
                    div {
                        class: "modal",
                        // Stop click from closing overlay when clicking inside modal
                        ...
                        if pro {
                            // Already activated — show status + deactivate option
                            p { class: "modal-desc",
                                "Your Pro license is active. You have access to CSV export, "
                                "Trade Lifecycle reconstruction, and all future Pro features."
                            }
                            ...
                            p { class: "modal-desc",
                                ...
                                "CSV export, Trade Lifecycle reconstruction, and more."
                            }
