...
.btn-process { background: #6ec007; color: #0f0f11; }
...
.btn-sample { background: transparent; color: #6ec007; border: 1px solid rgba(110,192,7,0.4); }
.btn-sample:hover { background: rgba(110,192,7,0.08); }
.btn-sample-inline {
...
.btn-sample-inline:hover { background: rgba(110,192,7,0.08); }
...
.fix-input:focus { outline: none; border-color: #6ec007; }
...
.tag-num { color: #6ec007; font-variant-numeric: tabular-nums; text-align: right; }
...
.time-op-select:focus { border-color: #6ec007; }
.col-filter {
    width: 100%;
    background: transparent;
    border: none;
...
.col-filter:focus { border-bottom-color: #6ec007; }
.btn-clear-filter {
    padding: 3px 10px;
    border-radius: 4px;
...
.badge-orange  { background: rgba(52,162,3,0.15);  color: #34a203; }
...
.badge-purple  { background: rgba(110,192,7,0.15);  color: #6ec007; }
.badge-yellow  { background: rgba(110,192,7,0.15);  color: #6ec007; }
...
.hero-stat-featured {
    padding: 22px 34px;
    border-color: rgba(110,192,7,0.35);
}
.hero-stat-value {
    font-size: 34px;
    font-weight: 700;
...
.hero-stat-featured .hero-stat-value { font-size: 40px; color: #6ec007; }
...
.hero-demo-time { color: #6ec007; font-weight: 700; }
.hero-bar-track {
    height: 4px;
    border-radius: 2px;
    background: #1d1d20;
...
.resize-handle:hover .resize-handle-bar::after { background: #6ec007; }
...
.feature-card-soon {
    border-color: rgba(110,192,7,0.2);
}
...
.btn-feature {
    padding: 4px 10px;
    border-radius: 4px;
    border: 1px solid rgba(110,192,7,0.35);
    background: transparent;
    color: #6ec007;
    font-size: 11px;
    font-weight: 600;
...
.btn-feature:hover { background: rgba(110,192,7,0.08); }
...
.lc-selected-id { font-size: 12px; color: #6ec007; font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, monospace; }
...
.latency-stat-yellow { border-color: #3d860b; } .latency-stat-yellow .latency-stat-val { color: #3d860b; }
.latency-stat-orange { border-color: #34a203; } .latency-stat-orange .latency-stat-val { color: #34a203; }
...
.latency-cell-p95  { color: #3d860b; font-variant-numeric: tabular-nums; }
...
.phase-light .health-yellow { color: #6ec007; }
...
.phase-light .phase-stat-yellow { border-color: #6ec007; } .phase-light .phase-stat-yellow .phase-stat-val { color: #6ec007; }
...
.recon-filter-input:focus { border-color: #6ec007; }
.recon-filter-btn {
    background: #0d0d0f;
    border: 1px solid #1d1d20;
    border-radius: 4px;
...
.status-partial   { color: #3d860b; font-weight: 600; font-size: 11px; }
...
.lc-sort-hdr:hover { color: #6ec007; }
.lc-sort-hdr-active { color: #c1d11f; font-weight: 700; }
...
.health-yellow { color: #3d860b; }
.health-orange { color: #34a203; }
.health-red    { color: #903030; }
.health-none   { color: #1d1d20; }
.phase-card:has(.health-yellow) { border-left: 3px solid #3d860b; }
.phase-card:has(.health-orange) { border-left: 3px solid #34a203; }
...
.phase-stat-yellow { border-color: #3d860b; } .phase-stat-yellow .phase-stat-val { color: #3d860b; }
.phase-stat-orange { border-color: #34a203; } .phase-stat-orange .phase-stat-val { color: #34a203; }
...
.summary-session-label { color: #6ec007; font-weight: 600; }
...
.scorecard-back-btn:hover { background: rgba(110,192,7,0.08); }
...
.sc-sorted { color: #6ec007 !important; }
...
.sc-ok   { color: #3d860b; font-family: ui-monospace, 'SF Mono', monospace; text-align: right; }
...
.validator-input:focus { outline: none; border-color: #6ec007; }
...
.vsummary-warn { color: #3d860b; font-weight: 600; }
...
.vstatus-warn { color: #3d860b; font-weight: 700; }
...
.vbatch-stat-warn .vbatch-stat-value { color: #3d860b; }
...
.vbatch-type  { color: #6ec007; font-weight: 600; }
