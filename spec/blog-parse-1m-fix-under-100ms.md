...
Everything below is the story of getting to **85ms** — and the lessons we learned along the way.
...
These got us from ~263ms to a reasonable starting point. But for 1M messages over 141MB, we were still at ~140ms.
...
After all the above, we profiled and found a surprising hot spot in the field model itself:
...
**Target achieved: 85ms for 1 million messages on 195 MB of SOH-delimited FIX data.**
